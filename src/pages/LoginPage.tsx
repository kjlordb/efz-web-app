...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#070b12] flex flex-col justify-center items-center relative overflow-x-hidden p-4 sm:p-6 select-none font-sans">
      {/* Ambient background glow meshes */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-gradient-to-tr from-teal-500/10 via-amber-500/5 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-teal-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-4xl z-10 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <div className="space-y-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-400/10 border border-amber-400/25 text-amber-300 text-xs font-bold tracking-wider uppercase shadow-inner">
        ...
        <div className="glass-panel rounded-3xl shadow-glass-modal overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-white/[0.12] divide-y lg:divide-y-0 lg:divide-x divide-white/[0.08]">
          
          {/* Left Panel: Instant Client Presentation Quick Launch (5 Cols) */}
          <div className="lg:col-span-5 p-6 sm:p-8 bg-slate-950/40 backdrop-blur-md flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-2.5 pt-1">
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="w-7 h-7 rounded-lg bg-teal-950/60 flex items-center justify-center text-teal-300 font-bold text-xs border border-teal-400/20">
                      🚀
                    </div>
          ...
          <div className="lg:col-span-7 p-6 sm:p-8 flex flex-col justify-between space-y-6 bg-slate-900/60 backdrop-blur-md">
            <div className="space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-500 hover:to-teal-600 text-white font-bold text-xs shadow-glass-xs hover:shadow-glow-teal transition-all flex items-center justify-center gap-2 mt-2 disabled:opacity-50"
                >
                  {isLoading ? (
            ...
            <div className="pt-4 border-t border-white/[0.08] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-[11px] text-slate-400">
